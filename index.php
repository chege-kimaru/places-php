<?php
    ...
    $featured_places = getFeaturedPlaces();
?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="slider-content_wrap">
                                ...
                                <h5>Best places to stay, eat, drink, and shop while in campus</h5>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="row d-flex justify-content-center">
...
<section class="main-block">
    <div class="container">
        ...
        <div class="row">
            <a class="col-md-4" href="listing.php?category=Accommodation">
            ...
            <div class="col-md-4">
                <a class="row find-img-align"  href="listing.php?category=foodAndDrink">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                ...
                <a class="row"  href="listing.php?category=Outdoors">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
            ...
            <div class="col-md-4">
                <a class="row find-img-align"  href="listing.php?category=Shopping">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                ...
                <a class="row"  href="listing.php?category=Services">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
        ...
        <div class="row">
            ...
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.php?place=<?php echo $place['id'];?>">
                        <img src="images/featured1.jpg" class="img-fluid" alt="#">
                        <span class="featured-rating-orange">6.5</span>
                        <div class="featured-title-box">
                            <h6><?php echo $place['name'];?></h6>
                            <p><?php echo $place['category'];?> </p> <span>• </span>
                            <p>3 Reviews</p> <span> • </span>
                            <p><span>KSH </span><?php echo $place['name'];?></p>
                            <ul>
                                <li><span class="icon-location-pin"></span>
                                    <p><?php echo $place['location'];?></p>
                                </li>
                                <li><span class="icon-screen-smartphone"></span>
                                    <p><?php echo $place['phone'];?></p>
                                </li>
                                <li><span class="icon-link"></span>
                                    <p><?php echo $place['website'];?></p>
                                </li>

                            </ul>
                            <div class="bottom-icons">
                                <div class="closed-now"><?php if($place['status'] == 1) echo 'OPEN'; else echo 'CLOSED'; ?> NOW</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 category-responsive">
                <a href="listing.php?category=Accommodation" class="category-wrap">
            ...
            <div class="col-md-3 category-responsive">
                <a href="listing.php?category=FoodAndDrink" class="category-wrap">
                    <div class="category-block">
                        <svg class="category-img" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-md-3 category-responsive">
                <a href="listing.php?category=Outdoors" class="category-wrap">
                    <div class="category-block">
                        <svg class="category-img" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-md-3 category-responsive">
                <a href="listing.php?category=Services" class="category-wrap">
                    <div class="category-block">
                        <svg class="category-img" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="row">
            <div class="col-md-3 category-responsive">
                <a href="listing.php?category=Shopping" class="category-wrap">
                    <div class="category-block">
                        <svg class="category-img" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-md-3 category-responsive">
                <a href="listing.php?category=Coffee" class="category-wrap">
                    <div class="category-block">
                        <svg class="category-img" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-md-3 category-responsive">
                <a href="listing.php?category=Destinations" class="category-wrap">
                    <div class="category-block">
                        <svg class="category-img" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="add-listing-wrap">
                    <h2>Reach lots of students</h2>
                    <p>Add your Business infront of students and earn 3x profits from our listing</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
